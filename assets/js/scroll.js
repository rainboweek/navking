(function() {
    function C() {
        if (!D && document.body) {
            ...
            if (top != self) v = !0;
                ...
                w = function() {
                    g ||
                        (g = setTimeout(function() { e.style.height = "0";
    ...
    function N(a, b, d) {
        ...
        t.push({ x: b, y: d, lastX: 0 > b ? .99 : -.99, lastY: 0 > d ? .99 : -.99, start: Date.now() });
        if (!F) {
            c = O();
    ...
    function R(a) {
        ...
        b = S(b);
        if (!b) return v && G ? (Object.defineProperty(a, "target", { value: window.frameElement }), a = new a.constructor(a.type, a), parent.dispatchEvent(a)) : !0;
        if (ia(c)) return !0;
        1.2 < Math.abs(d) && (d *= f.stepSize / 120);
        1.2 < Math.abs(c) && (c *= f.stepSize /
            120);
        N(b, d, c);
        a.preventDefault();
        T()
    ...
    function M(a) {
        ...
        if (!(c = a.defaultPrevented || c.test(b.nodeName) || r(b, "input") && !e.test(b.type) || r(m, "video"))) {
            ...
            if (-1 != document.URL.indexOf("www.youtube.com/watch")) {
                do
                    if (h = c.classList && c.classList.contains("html5-video-controls")) break;
        ...
        switch (a.keyCode) {
            ...
            case g.home:
                d == document.body &&
                    document.scrollingElement && (d = document.scrollingElement);
                c = -d.scrollTop;
                break;
            case g.end:
    ...
    function U(a) { m = a.target }

    function T() { clearTimeout(V);
        V = setInterval(function() { W = H = A = {} }, 1E3) }

    function I(a, b, d) { d = d ? W : H; for (var c = a.length; c--;) d[J(a[c])] = b; return b }
    ...
    function S(a) {
        ...
        do {
            ...
            if (e) return I(b,
                e);
            b.push(a);
            if (c === a.scrollHeight) { if (e = X(l) && X(d) || Y(l), v && l.clientHeight + 10 < l.scrollHeight || !v && e) return I(b, O()) } else if (a.clientHeight + 10 < a.scrollHeight && Y(a)) return I(b, a)
        } while (a = a.parentElement)
    }

    function X(a) { return "hidden" !== getComputedStyle(a, "").getPropertyValue("overflow-y") }

    function Y(a) { a = getComputedStyle(a, "").getPropertyValue("overflow-y"); return "scroll" === a || "auto" === a }

    function fa(a) { var b = J(a);
        null == A[b] && (a = getComputedStyle(a, "")["scroll-behavior"], A[b] = "smooth" == a); return A[b] }

    function r(a, b) { return a && (a.nodeName || "").toLowerCase() === b.toLowerCase() }

    function ea(a, b) { a = 0 < a ? 1 : -1;
        b = 0 < b ? 1 : -1; if (B.x !== a || B.y !== b) B.x = a, B.y = b, t = [], E = 0 }

    function ia(a) { if (a) return h.length || (h = [a, a, a]), a = Math.abs(a), h.push(a), h.shift(), clearTimeout(Z), Z = setTimeout(function() { try { localStorage.SS_deltaBuffer = h.join(",") } catch (b) {} }, 1E3), a = 120 < a && K(a), !K(120) && !K(100) && !a }

    function x(a, b) { return Math.floor(a / b) == a / b }

    function K(a) { return x(h[0], a) && x(h[1], a) && x(h[2], a) }
    ...
    function y(a) { for (var b in a) aa.hasOwnProperty(b) && (f[b] = a[b]) }
    var aa = { frameRate: 150, animationTime: 400, stepSize: 100, pulseAlgorithm: !0, pulseScale: 4, pulseNormalize: 1, accelerationDelta: 50, accelerationMax: 3, keyboardSupport: !0, arrowScroll: 50, fixedBackground: !0, excluded: "" },
        f = aa,
        v = !1,
        B = { x: 0, y: 0 },
        D = !1,
        ...
        F = !1,
        E = Date.now(),
        J = function() { var a = 0; return function(b) { return b.uniqueID || (b.uniqueID = a++) } }(),
        W = {},
        H = {},
        V, A = {};
    if (window.localStorage && localStorage.SS_deltaBuffer) try { h = localStorage.SS_deltaBuffer.split(",") } catch (a) {}
    var Q = function() { return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(a, b, d) { window.setTimeout(a, d || 1E3 / 60) } }(),
        da = window.MutationObserver ||
        window.WebKitMutationObserver || window.MozMutationObserver,
        O = function() { var a = document.scrollingElement; return function() { if (!a) { var b = document.createElement("div");
                    b.style.cssText = "height:10000px;width:1px;";
                    document.body.appendChild(b); var d = document.body.scrollTop;
                    window.scrollBy(0, 3);
    ...
    k = (G || u || la) && !ka;
    var ba = !1;
    try { window.addEventListener("test", null, Object.defineProperty({}, "passive", { get: function() { ba = !0 } })) } catch (a) {}
    u = ba ? { passive: !1 } : !1;
    ...
    "function" === typeof define && define.amd ? define(function() { return y }) : "object" == typeof exports ? module.exports = y : window.SmoothScroll = y
})();